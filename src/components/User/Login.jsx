            ...
            <main className="flex flex-col items-center justify-center w-full h-full px-20 text-center ">
                <div className='bg-white rounded-2xl shadow-2xl flex w-full max-w-4xl maindiv'>
                    ...
                    <div className='w-full md:w-3/5 p-5 rightdiv'>
                        ...
                        <div className="flex flex-col items-center">
                            <button className="flex items-center border-2 border-green-500 rounded-lg px-6 py-2 font-semibold hover:bg-green-500 hover:text-white">
                                <FaGoogle className="text-orange-500 mr-2" />
                                Login with Google
                            </button>
                            <div className="flex flex-col justify-center mt-2">
                                <Link to="/Playerlogin">
                                    <button className="border-2 border-green-500 text-green-500 rounded-lg px-6 py-2 font-semibold hover:bg-green-500 hover:text-white transition-all mb-2 duration-300">
                                        Login as Player
                                    </button>
                                </Link>
                                <Link to="/Teamlogin">
                                    <button className="border-2 border-green-500 text-green-500 rounded-lg px-6 py-2 font-semibold ml-2 hover:bg-green-500 hover:text-white transition-all duration-300">
                                        Login as Management
                                    </button>
                                </Link>
                            </div>
                    ...
                    {/* Left side */}
                    <div className='leftdiv w-full md:w-2/5 bg-green-500 text-white rounded-tr-2xl rounded-br-2xl py-8 md:py-36 px-4 md:px-12 flex flex-col justify-center items-center'>
                        <h2 className='text-3xl font-bold mb-2'>SmartCricket</h2>
                        <div className='border-2 w-10 border-white inline-block mb-2'></div>
                        <img src={cricketImage} alt="Cricket Image" className="w-60 h-60 mb-4" />
                    </div>
                </div>
            </main>
        </div>
