...
const TeamSignup = () => {
  ...
  const handleSignUp = (e) => {
    ...
    toast.success(
      `Signup successful with first name: ${name}, email: ${email}`
    ); // Show success toast
  };
      ...
      <main className="flex flex-col items-center justify-center w-full h-full px-4 md:px-20 text-center">
        <div className="bg-white rounded-2xl shadow-2xl flex w-full max-w-4xl maindiv">
          ...
          <div className="w-full md:w-2/5 bg-green-500 text-white rounded-tl-2xl rounded-bl-2xl py-8 md:py-16 px-4 md:px-12 flex flex-col justify-center items-center">
            <h2 className="text-2xl md:text-3xl lg:text-3xl xl:text-3xl font-bold mb-2">
              SmartCricket
            </h2>
            <img
              src={managementloginpic}
              alt="Cricket Image"
              className="w-40 md:w-56 lg:w-72 xl:w-96 h-40 md:h-56 lg:h-72 xl:h-96 mb-4"
            />
          </div>
          {/* Right side */}
          <div className="w-full md:w-3/5 p-5">
            <div className="py-10">
              <h2 className="text-2xl md:text-3xl lg:text-3xl xl:text-3xl font-bold text-green-500 mb-2">
                Team SignUp
              </h2>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="bg-gray-100 w-full md:w-72 p-2 flex items-center mb-4 rounded-lg input-container">
                  ...
                  <div className="relative flex-1">
                    ...
                    >
                      {showPassword ? (
                        <MdVisibilityOff className="text-xs md:text-sm lg:text-base xl:text-base" />
                      ) : (
                        <MdVisibility className="text-xs md:text-sm lg:text-base xl:text-base" />
                      )}
                    </button>
                  </div>
                </div>
                ...
                {error && (
                  <p className="text-red-500 text-xs md:text-sm lg:text-base xl:text-base mb-4">
                    {error}
                  </p>
                )}
                <button
                ...
                <div className="mt-4">
                  <p className="text-xs md:text-sm lg:text-base xl:text-base">
                    ...
                    <Link to="/Teamlogin" className="text-green-500">
                      Sign In
                    </Link>
                  </p>
                </div>
                <div className="flex flex-col items-center justify-center my-4">
                  <span className="text-xs md:text-sm lg:text-base xl:text-base">
                    -----Or-----
                  </span>
                  <div className="mt-4">
