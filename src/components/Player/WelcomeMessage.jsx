...
import { FaUser, FaSmile } from 'react-icons/fa';
...
const WelcomeMessage = () => {
  ...
  return (
    <div className="flex  items-center justify-between bg-[#00A09A] text-white p-6 rounded-lg shadow-lg dark:text-white" style={{flexWrap:'wrap', textAlign:'center'}}>
      <div className="flex flex-col items-center md:items-start mb-6 md:mb-0 md:w-1/2 text-center md:text-left">
        ...
        <h2 className="text-sm sm:text-md md:text-lg lg:text-xl  font-bold text-center md:text-left">
