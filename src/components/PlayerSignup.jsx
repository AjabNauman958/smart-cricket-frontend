    ...
    <main className="flex flex-col items-center justify-center w-full h-full px-20 text-center">
        <div className='bg-white rounded-2xl shadow-2xl flex w-full max-w-4xl'>
            ...
            <div className='w-full md:w-3/5 p-5'>
                ...
                <div className='py-10'>
                    <h2 className='text-3xl font-bold text-green-500 mb-2'>Player SignUp</h2>
                ...
                <form onSubmit={handleSignUp}>
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='bg-gray-100 w-full md:w-64 p-2 flex items-center mb-3'>
                            <FaRegEnvelope className="text-gray-400 m-2" />
                            <input required type='text' name='country' value={country} onChange={(e) => setCountry(e.target.value)} placeholder='Enter your Country Name' className='bg-gray-100 outline-none text-sm flex-1 rounded-lg' />
                        </div>
                        ...
                        <div className="mt-4">
                            <p className="text-sm">Already have an account? <Link to="/Playerlogin" className="text-green-500">Sign In</Link></p>
                        </div>
                    </div>
                </form>
